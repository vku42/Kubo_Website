...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#fcfcfc] border-t border-[#d2d2d7]/30 pt-24 pb-12 flex flex-col items-center">
      <div className="w-full max-w-5xl px-6 grid grid-cols-1 md:grid-cols-2 gap-16 mb-24">
        ...
        <div className="flex gap-16 md:justify-end">
          ...
          <div className="flex flex-col gap-4">
            <h4 className="font-bold text-[#1d1d1f]">Connect</h4>
            <a href="https://www.instagram.com/thekubobot/" target="_blank" rel="noopener noreferrer" className="text-[#86868b] hover:text-[#1d1d1f] transition">Instagram</a>
            <a href="https://twitter.com/thekubobot" target="_blank" rel="noopener noreferrer" className="text-[#86868b] hover:text-[#1d1d1f] transition">Twitter / X</a>
            <a href="mailto:hello@kubobot.com" className="text-[#86868b] hover:text-[#1d1d1f] transition">Email Us</a>
          </div>
          <div className="flex flex-col gap-4">
      ...
      <div className="w-full max-w-5xl px-6 flex flex-col md:flex-row justify-between items-center gap-4 pt-8 border-t border-black/5">
        ...
        <span className="text-sm text-[#86868b] font-medium">
          © {new Date().getFullYear()} Kubo Robotics. All rights reserved.
        </span>
      </div>
    </footer>
  );
