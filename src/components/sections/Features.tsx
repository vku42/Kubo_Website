...
const features = [
  {
    title: "The only one who won't tell.",
    description: "Kubo processes every reaction locally on its ESP32-C3 core. Hardware-locked privacy for your sacred space.",
    icon: <Brain className="w-6 h-6 text-[#1d1d1f]" />,
    span: "col-span-1 md:col-span-2",
    stat: "100% Offline",
    statLabel: "The safest partner",
  },
  {
    title: "Pure OLED Soul",
    description: "A 1.3\" deep-black display brings subtle kinetic life to your desk. He blinks, he looks, he waits.",
    icon: <Sparkles className="w-6 h-6 text-[#1d1d1f]" />,
    span: "col-span-1",
    stat: "20+ Moods",
    statLabel: "Animated reactions",
  },
  {
    title: "Late Night Presence",
    description: "Integrated deep-work timers that fight loneliness by reacting to your focused presence.",
    icon: <Zap className="w-6 h-6 text-[#1d1d1f]" />,
    span: "col-span-1",
    stat: "Always Ready",
    statLabel: "He's here for you",
  },
  {
    title: "He cares about you.",
