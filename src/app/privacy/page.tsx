      ...
      <div className="w-full max-w-3xl">
        ...
        <div className="space-y-16">
          ...
          <section>
            ...
            <p className="text-[#86868b] leading-relaxed font-medium text-lg">
              We will never sell, lease, or distribute your personal information to third parties. Your data is only used by <strong>Vehon Infotech</strong> (the registered legal entity operating this site) and our essential shipping partners solely to deliver your pre-order.
            </p>
          </section>
